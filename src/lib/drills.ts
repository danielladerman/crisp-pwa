...
export interface Category {
  ...
  name: string;
  subtitle: string;
  color: string; // CSS variable name, e.g. "cat-presence"
}
...
export const CATEGORIES: Category[] = [
  { id: "presence", name: "Presence", subtitle: "Regulating under pressure, not performing through it", color: "cat-presence" },
  { id: "thinking", name: "Thinking", subtitle: "The work that happens before you talk", color: "cat-thinking" },
  { id: "pattern-breaking", name: "Pattern Breaking", subtitle: "Replacing habits with conscious choices", color: "cat-pattern-breaking" },
  { id: "emotional-precision", name: "Emotional Precision", subtitle: "Saying what you actually feel", color: "cat-emotional-precision" },
...
export function getDrillsByCategory(categoryId: CategoryId): Drill[] {
  return DRILLS.filter((d) => d.category === categoryId);
}

export function getRandomDrill(): Drill {
